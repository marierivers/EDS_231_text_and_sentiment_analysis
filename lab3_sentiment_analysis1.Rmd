...
```{r}
setwd("/Users/marierivers/Documents/UCSB_Environmental_Data_Science/EDS_231_Text_and_Sentiment_Analysis/EDS_231_text_and_sentiment_analysis")
...
my_files <- list.files(pattern = ".docx", path = getwd(), "/data",
